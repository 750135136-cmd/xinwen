...
# ========= 相册处理（完全还原原生逻辑，仅修复拆分，1.42.0完美兼容） =========
async def album_handler(event):
    try:
        ...
        # ========= 唯一修复：只过滤无媒体的消息，强制保证媒体和caption长度1:1匹配，彻底解决拆分 =========
        # 只过滤完全无媒体的消息，直接用原生media，和你最开始的逻辑完全一致
        valid_media_list = []
        for m in msgs:
            if m.media:
